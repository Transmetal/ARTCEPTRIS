                ...
                <tbody>
                    ...
                    while($row = $all_buyer->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo 'Rp'.number_format($row['payment_price'], 2) ?>
                            </td>
                            <td>
                                <?php echo $row['status'] ?>
                            </td>
                            <td>
                                <a href="editbuyer.php?id=<?php echo $row['buyer_id']; ?>&movie_id=<?php echo $row['movie_id']; ?>&transaction_no=<?php echo $row['transaction_no']; ?>"
                    ...
                    <script>
                        ...
                        $(document).ready(function () {
                            $('.searchinput').keyup(function () {
                                ...
                                // Perform AJAX request to your server-side script (searchMovies.php)
                                $.ajax({
                                    type: 'POST',
                                    url: 'searchbuyer.php',
                                    data: {
                                ...
                                if (data.length > 0) {
                                    ...
                                    $.each(data, function (index, row) {
                                        ...
                                        newRow += '<a href="editbuyer.php?id=' + encodeURIComponent(row
                                            .buyer_id) +
                                            '&movie_id=' + encodeURIComponent(row.movie_id) +
