        ...
        <form action="" method="post">
            ...
            <image src="css/images/Layout.png" id="seatimage">
                <div class="wrapper">
                    ...
                    <a href="pickseatscash.php" class="cta-button2">Choose a Seat</a>
            ...
            try {
                if(!is_null($selectedSeatIds) && !empty($selectedSeatIds)) {
                    ...
                    for($i = 0; $i < $count; $i++) {
                        ...
                        $query = "INSERT INTO `chosenseats` (movieid, seatid, seatnames, status) VALUES ('$movieId', '$seatId', '$seatNames  ', 'Reserved')";
                    ...
                    $insertuser = "INSERT INTO `tblbuyer` (buyer_id, buyer_name, buyer_chosenseats, payment_mode, buyer_phonenum, movie_name, movie_id, movie_date, tickets_qty, payment_date, transaction_no, payment_price, status)
                                  VALUES ('$user_id', '{$fetchuser['fullname']}', '$selectedSeats', 'Cash', '{$fetchuser['phonenum']}', '{$fetchcon['movie_name']}', '{$fetchcon['movie_id']}','{$fetchcon['movie_date']}', '$selectedSeatsCount', NOW(), '$transactionNumber',$totalPrice, 'Pending')";
...
<script>
    ...
    function redirectToAnotherPageCash(movieId, seats, quantity, seatscount, transactionNumber) {
        ...
        if (Cash) {
            var url = 'paymentinfocash.php?movie_id=' + movieId + '&selected_seats=' + seats +
