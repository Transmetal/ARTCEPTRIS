...
<body>
    <div class="container">
        ...
        ?>
            ...
            <br><br>
            <a href="home.php" id="cardlink" class="back-btn"><i class="fas fa-arrow-left"></i></a>
        </form>
        ...
        <div class="card1">
            ...
            <p class="p1">
                ...
                <span></span>
                <span></span>
                Silahkan masukkan huruf dan angka yang sesuai untuk seluruh input box yang tertera
            </p>
        </div>
        <div class="card3">
            <h3>Fungsi fitur credit ▼</h3>
            <p class="p3">
                <span></span>
                <span></span>
                <span></span>
                <span></span>
                Anda dapat mengisi secara detail penggunaan profil credit anda untuk pemesanan seat, pembayaran secara cash juga tersedia dihalaman sebelumnya
            </p>
        </div>
    </div>
